...
<body>
		  ...
		  <div class="tab-content">
		    <div role="tabpanel" class="tab-pane active" id="home">
				...
				<div class="text-right">
					...
					<button ontouchend="window.location.href='<%=basePath%>/ctrlUnitSaleQuarterProgress/table?ctrlUnitId=<%=encodeCtrlUnitId%>'" type="button" class="btn btn-primary btn-xs" style="padding:4px 9px;">
				...
				<div style="padding-top: 10px;">
					<button ontouchend="window.location.href='<%=basePath%>/ctrlUnitProgress/chart'" class="btn btn-block btn-primary">
						返&emsp;回
					</button>
				</div>
	...
	<script>
		...
		;(function(){// 集团全年认购情况
			...
			var getChartUrl = "<%=basePath%>/ctrlUnitSaleQuarterProgress/getCtrlUnitSaleQuarterBackProgressHist?ctrlUnitId="+encodeURIComponent("<%=ctrlUnitId%>");
			...
			.done(function(data) {
				...
				renderChart(
					...
					[0,1,1],
					{
						title: data.ctrlUnitName + "各季度认购情况",

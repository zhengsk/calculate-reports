...
<body>
		  ...
		  <div class="tab-content">
		    <div role="tabpanel" class="tab-pane active" id="home">
				...
				<div class="text-right" style="margin-bottom:5px;">
					...
					<button ontouchend="window.location.href='<%=basePath%>/ctrlUnitSaleQuarterProgress/chart?ctrlUnitId=<%=encodeCtrlUnitId%>'" type="button" class="btn btn-primary btn-primary btn-xs" style="padding:4px 9px;">
				...
				<div>
					<div class="swipeWrapper" style="height:200px;">
						<div id="swipeTable">
							<table class="table-striped" style="font-size:0.8em;" id="sectionListTable" data-toggle="table" data-cache="false" data-url="<%=basePath%>/ctrlUnitSaleQuarterProgress/getCtrlUnitSaleQuarterBackProgress?ctrlUnitId=<%=encodeCtrlUnitId%>" data-response-handler="responseHandler">
							    <thead style="font-size:1em;">
							        <tr class="table-title">
							            <th data-field="quarter" data-align="center" id="ctrlUnitName">事业部</th>
							            <th data-field="saleTargetAmount" data-align="right" data-formatter="tdFormat">认购指标</th>
							            <th data-field="saleAmount" data-align="right" data-formatter="tdFormat">已认购额</th>
							            <th data-field="percent" data-align="right">认购率</th>
							        </tr>
							    </thead>
							</table>
						</div>
				...
				<div style="padding-top: 10px;">
					<button ontouchend="window.location.href='<%=basePath%>/ctrlUnitProgress/table'" class="btn btn-block btn-primary">
						返&emsp;回
					</button>
				</div>
	...
	<script>
	    ...
	    function responseHandler(res){
			...
			setProgressBar(
				'progressBar', 
				data.ctrlUnitName + "年度认购指标:{{yearTotal}}万，已完成:{{yearDone}}万",
				progressData  // 设置进度条
			);

...
<body>
		  ...
		  <div class="tab-content">
		    <div role="tabpanel" class="tab-pane active" id="home">
				...
				<div class="text-right" style="margin-left:4px">
					...
					<button ontouchend="window.location.href='<%=basePath%>/ctrlUnitProgress/table'" type="button" class="btn btn-primary btn-primary btn-xs" style="padding:4px 9px;">
				...
				<div style="width:100%;">
					<div id="chartCanvasTarget" style="height:900px;"></div>
				</div>
	...
	<script>
		...
		;(function(){// 集团全年认购情况
			...
			var getChartUrl = "<%=basePath%>/ctrlUnitProgress/getCtrlUnitSaleProgressHist";
			...
			.done(function(data) {
				...
				var progressData = {
					...
					groupUnitPage : "<%=basePath%>/ctrlUnitSaleQuarterProgress/chart?ctrlUnitId=" + encodeURIComponent(data.total.groupUnitId)	// 跳转集团季度 链接地址 TODO:修改地址
				}
				// 设置进度条
				setProgressBar(
					'progressBar', 
				...
				myChart.on('click', function(param) {
				    ...
				    if(param.seriesIndex == -1 && param.name){
				    	...
				    	// TODO: 修改跳转地址
				    	window.location = "<%=basePath%>/ctrlUnitSaleQuarterProgress/chart?ctrlUnitId=" + encodeURIComponent(id);
				    }
				});

...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        onTouchEnd: function (item, $element) {
            return false;
        },
    ...
    BootstrapTable.EVENTS = {
        ...
        'touch-end-row.bs.table': 'onTouchEnd',
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                cellStyle = calculateObjectValue(that.header,
                    that.header.cellStyles[j], [value, item, i, item[field]], cellStyle);
        ...
        this.$body.find('tr').off('dblclick').on('dblclick', function () {
            ...
            that.trigger('touch-end-row', that.data[$(this).data('index')], $(this));
        });
    ...
    BootstrapTable.prototype.resetFooter = function () {
        ...
        $.each(this.options.columns, function (i, column) {
            var falign = '', // footer align style
                style = '',
                columnClassName = column['class']; // zsk 扩展

            if(columnClassName){
                 columnClassName = column.cellFooterStyle ? (column['class'] + '' + column.cellFooterStyle) : columnClassName;
            }else{
                columnClassName = column.cellFooterStyle || undefined;
            }

            var class_ = sprintf(' class="%s"',  columnClassName);
            ...
            html.push(calculateObjectValue(column, column.footerFormatter, [data, column], '&nbsp;') || '&nbsp;');
            html.push('</td>');
        });
    ...
    BootstrapTable.prototype.resetView = function (params) {
        ...
        if (this.options.showHeader && this.options.height) {
            this.$container.find('.fixed-table-header').show();
            this.resetHeader();
            padding += this.options.headerHeight || cellHeight;
        } else {
            this.$container.find('.fixed-table-header').hide();
